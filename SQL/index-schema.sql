...
ON venues
USING btree (city, state, country, address)

CREATE INDEX venues_city_index
ON venues
USING btree (city)

CREATE INDEX venues_state_index
ON venues
USING btree (state)

CREATE INDEX venues_address_index
ON venues
USING btree (address)

CREATE INDEX venues_city_state_index
ON venues
USING btree (city, state)

CREATE INDEX venues_city_address_index
ON venues
USING btree (city, address)
...
ON events
USING btree (startDateSale, endDateSale)

CREATE INDEX events_startDateEvent_index
ON events
USING btree (startDateEvent)

CREATE INDEX events_price_range_index
ON events
USING btree (minPrice, maxPrice)
